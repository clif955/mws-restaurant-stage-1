...
initMap = () => {
  ...
  L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
    mapboxToken: 'pk.eyJ1IjoiY2xpZjk1IiwiYSI6ImNqaWw4NW5neDBoeGUzcW15bmxuY2pqbXIifQ.mVuqzbKeC5eI37Ape7QNfg',
    maxZoom: 18,
...
const createRestaurantHTML = (restaurant) => {
  ...
  */
  ...
  restaurant.alt="Image of" + restaurant.name + "Restaurant";
  li.append(image);
